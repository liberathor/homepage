    ...
    <div class="box">
        <section class="section is-medium">
            <div class="container has-text-centered">
                <h1 class="title">SCANERY: PRIVACE POLICY</h1>
                <br/>
            </div>
            <p> Liberathion Studios built the Scanery app as an Ad Supported app. This SERVICE is provided by
                Liberathion
                Studios at no cost and is intended for use as is.
            </p>
            ...
            <p>The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, which is
                accessible at Scanery unless otherwise defined in this Privacy Policy.
            </p>
            <br/>
            <h2 class="title">Information Collection and Use</h2>
            <p>For a better experience, while using our Service, we may require you to provide us with certain
                personally
                identifiable information, including but not limited to Juan Carlos Ram{irez Vargas,
                liberathion@gmail.com.
            ...
            or
            refuse these cookies and know when a cookie is being sent to your device. If you choose to refuse our
            cookies,
