<template>
  <section class="section is-medium">
    ...
    <p> Juan Carlos Ramírez built the Super Ear app as an Ad Supported app. This SERVICE is provided by Juan Carlos
      Ramírez
    ...
    <p>For a better experience, while using our Service, I may require you to provide us with certain
      personally identifiable information, including but not limited to RECORD AUDIO. The information that I request
      is
    ...
    <div><p>Link to privacy policy of third party service providers used by the app </p>
      <br/>
      <ul>
        <li><a href="https://www.google.com/policies/privacy/super-ear-privacy.vue" target="_blank">Google Play
          Services</a></li>
