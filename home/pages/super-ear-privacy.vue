    ...
    <div class="box">
        <section class="section is-medium">
            <div class="container has-text-centered">
                <h1 class="title">SUPER EAR: PRIVACE POLICY</h1>
                <br/>
            </div>
            <p> Juan Carlos Ramírez built the Super Ear app as an Ad Supported app. This SERVICE is provided by Juan
                Carlos
                Ramírez
            ...
            <p>The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, which is
                accessible
                at Super Ear unless otherwise defined in this Privacy Policy.
            </p>
            <br/>
            ...
            <p>For a better experience, while using our Service, I may require you to provide us with certain
                personally identifiable information, including but not limited to RECORD AUDIO. The information that I
                request
                is
            ...
            <div><p>Link to privacy policy of third party service providers used by the app </p>
                <br/>
                <ul>
                    <li><a href="https://www.google.com/policies/privacy/super-ear-privacy.vue" target="_blank">Google
                        Play
                        Services</a></li>
            ...
            <p>This Service does not use these “cookies” explicitly. However, the app may use third party code and
                libraries
                that use “cookies” to collection information and to improve their services. You have the option to
                either
