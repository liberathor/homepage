    ...
    <div class="box">
        <section class="section is-medium">
            <div class="container has-text-centered">
                <h1 class="title">SCANERY: TERMS AND CONDITIONS</h1>
                <br/>
            </div>
            <p>By downloading or using the app, these terms will automatically apply to you – you should make sure
                ...
                intellectual property rights related to it, still belong to Liberathion Studios.</p>
            <br/>
            <p>Liberathion Studios is committed to ensuring that the app is as useful and efficient as possible. For
                ...
                for.</p>
            <br/>
            <p>The Scanery app stores and processes personal data that you have provided to us, in order to provide our
                ...
                could mean that the Scanery app won’t work properly or at all. </p>
            <br/>
            <p>You should be aware that there are certain things that Liberathion Studios will not take responsibility
                for. Certain functions of the app will require the app to have an active internet connection. The
                connection can be Wi-Fi, or provided by your mobile network provider, but Liberathion Studios cannot
                take responsibility for the app not working at full functionality if you don’t have access to Wi-Fi, and
                you don’t have any of your data allowance left.</p>
            <p></p>
            <br/>
            <p>If you’re using the app outside of an area with Wi-Fi, you should remember that your terms of the
                ...
                using the app.</p>
            <br/>
            <p>Along the same lines, Liberathion Studios cannot always take responsibility for the way you use the app
                i.e. You need to make sure that your device stays charged – if it runs out of battery and you can’t turn
                it on to avail the Service, Liberathion Studios cannot accept responsibility.</p>
            <p>With respect to Liberathion Studios’s responsibility for your use of the app, when you’re using the app,
                it’s important to bear in mind that although we endeavour to ensure that it is updated and correct at
                all times, we do rely on third parties to provide information to us so that we can make it available to
                you. Liberathion Studios accepts no liability for any loss, direct or indirect, you experience as a
            ...
            <p>At some point, we may wish to update the app. The app is currently available on Android – the
                ...
                to) may change, and you’ll need to download the updates if you want to keep using the app. Liberathion
                Studios does not promise that it will always update the app so that it is relevant to you and/or works
